...
let equal_int a b =
  ...
  | UInt64 a, Integer b -> Int64.( = ) a (Int64.of_int b)
  | Integer a, UInt64 b -> Int64.( = ) (Int64.of_int a) b
  | _ -> false
;;
